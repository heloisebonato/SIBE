                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-12">
                            <div className="table-responsive">
                                ...
                                {produtosAtivos.sort((a, b) => b.locacao_id - a.locacao_id).map((produtosAtivos) => {
                                    return (
                                        <div className="infos-body">
                                            <div className="row" key={produtosAtivos.locacao_id}>
                                                <div className="col-lg-1 conf">
                                                    <div className="text">{produtosAtivos.locacao_id}</div>
                                                </div>
                                                <div className="col-lg-3 conf">
                                                    <div className="text">{produtosAtivos.nome}</div>
                                                </div>
                                                <div className="col-lg-2 conf">
                                                    <div className="text">{produtosAtivos.data_saida}</div>
                                                </div>
                                                <div className="col-lg-2 conf">
                                                    <div className="text">{produtosAtivos.data_prevista_saida}</div>
                                                </div>
                                                <div className="col-lg-4 conf">
                                                    <div className='btn-group mr-2'>
                                                        
                                                        <div className='btn-group mr-2'>
                                                            <Link to={`/locacao/${produtosAtivos.locacao_id}/editar`} exact className='btn btn-action btn-sm btn-outline-secondary'><EditIcon /></Link>
                                                        </div>


                                                        <Link to={`/historico/${produtosAtivos.cliente_id}`} exact className="btn btn-action btn-sm btn-outline-secondary"> Histórico</Link>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
